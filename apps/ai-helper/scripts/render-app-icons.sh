...
SOURCE_SVG="${ROOT_DIR}/docs/images/ai-helper-icon.svg"
OUTPUT_DIR="${ROOT_DIR}/AIHelper/Assets.xcassets/AppIcon.appiconset"

usage() {
  cat <<'EOF'
Usage: render-app-icons.sh [--source <svg-path>] [--output-dir <path>]

Regenerates the macOS AppIcon asset set from the ai-helper SVG source.
