...
ARCHIVE_PATH="$BUILD_DIR/AIHelperAppStore.xcarchive"
EXPORT_PATH="$BUILD_DIR/export"
EXPORT_OPTIONS="$BUILD_DIR/ExportOptions-AppStore.plist"
TEAM_ID="${PING_ISLAND_TEAM_ID:-K46RM9974S}"
SCHEME="${PING_ISLAND_APP_STORE_SCHEME:-AIHelperAppStore}"
PROJECT_FILE="${PING_ISLAND_PROJECT_FILE:-AIHelper.xcodeproj}"
SKIP_SIGNING="${PING_ISLAND_SKIP_APP_STORE_SIGNING:-0}"
UPLOAD="${PING_ISLAND_APP_STORE_UPLOAD:-0}"
APP_STORE_ENTITLEMENTS="$PROJECT_DIR/AIHelper/Resources/AIHelper-AppStore.entitlements"
APP_GROUP_ID="group.com.wfly.aihelper"
