...
private struct PosterOptions {
    ...
    init(arguments: [String]) throws {
        ...
        var outputName = "ai-helper-auto-update-poster.png"
        var width = 2800
        var height = 1800
    ...
    var errorDescription: String? {
        ...
        case .helpText:
            ...
            Usage: render-auto-update-poster.sh [options]
              ...
              --output-name <name>  Output filename (default: ai-helper-auto-update-poster.png)
    ...
    private var narrativeCard: some View {
        VStack(alignment: .leading, spacing: 28) {
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                Text("0.1.0 合并了 0.0.5 到 0.0.9 的更新能力，并接入 Sparkle 自动更新链路。ai-helper 会在启动和会话空闲时静默检查新版本，后台完成下载与准备。")
