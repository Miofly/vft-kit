...
private struct PosterOptions {
    ...
    init(arguments: [String]) throws {
        ...
        var outputName = "ai-helper-openclaw-poster.png"
        var width = 2800
        var height = 1800
        var iconURL = cwd.appendingPathComponent("AIHelper/Assets.xcassets/AppIcon.appiconset/icon_1024x1024.png")
        var logoURL = cwd.appendingPathComponent("AIHelper/Assets.xcassets/OpenClawLogo.imageset/openclaw-logo.png")
    ...
    var errorDescription: String? {
        ...
        case .helpText:
            ...
            Usage: render-openclaw-poster.sh [options]
              ...
              --output-name <name>  Output filename (default: ai-helper-openclaw-poster.png)
              --width <pixels>      Canvas width (default: 2800)
              --height <pixels>     Canvas height (default: 1800)
              --icon <path>         ai-helper app icon path
...
private struct OpenClawPosterView: View {
        ...
        HStack(spacing: 58) {
            ...
            VStack(alignment: .leading, spacing: 18) {
                HStack(spacing: 14) {
                    ...
                    Badge(text: "ai-helper", tint: Color(red: 0.82, green: 0.54, blue: 0.20))
                }
    ...
    private var narrativeCard: some View {
        VStack(alignment: .leading, spacing: 26) {
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                Text("ai-helper 会管理 `~/.openclaw/hooks/ai-helper-openclaw`，同步启用 `openclaw.json`，随后从 `~/.openclaw/agents/main/sessions/` 回读会话，避免 UI 只剩下一条入站消息。")
    ...
    private var pathCard: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("~/.openclaw/hooks/ai-helper-openclaw")
