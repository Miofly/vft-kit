...
BRAND_LOGO_SOURCE="${PING_ISLAND_DMG_LOGO_SOURCE:-$PROJECT_DIR/docs/images/ai-helper-icon-transparent.svg}"
...
FALLBACK_ICON_PNG="$PROJECT_DIR/AIHelper/Assets.xcassets/AppIcon.appiconset/icon_1024x1024.png"

VOLNAME=""
SOURCE_DIR=""
OUTPUT_DMG=""
APP_NAME="ai-helper.app"
...
TMP_DIR="$(mktemp -d "${TMPDIR:-/tmp}/ai-helper-dmg.XXXXXX")"
