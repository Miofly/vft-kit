...
func drawBackground(configuration: Configuration) throws {
    ...
    guard
        ...
        throw NSError(domain: "AIHelperDMG", code: 65, userInfo: [NSLocalizedDescriptionKey: "Failed to allocate bitmap"])
    }
    ...
    guard let context = NSGraphicsContext(bitmapImageRep: bitmap) else {
        throw NSError(domain: "AIHelperDMG", code: 66, userInfo: [NSLocalizedDescriptionKey: "Failed to create graphics context"])
    }
    ...
    let title = NSAttributedString(string: "AI-HELPER", attributes: titleAttributes)
    ...
    guard let data = bitmap.representation(using: .png, properties: [:]) else {
        throw NSError(domain: "AIHelperDMG", code: 67, userInfo: [NSLocalizedDescriptionKey: "Failed to encode PNG"])
    }
