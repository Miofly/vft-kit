...
private let repositoryURL = "https://github.com/Miofly/vft-kit"
...
func installerWritesVSCodeCompatibleExtensionPayload() throws {
    ...
    let vscodeExtensionURL = root
        ...
        .appending(path: "ai-helper.session-focus-\(version)", directoryHint: .isDirectory)
    ...
    #expect(packageJSON.contains("\"publisher\": \"ai-helper\""))
    #expect(packageJSON.contains("\"displayName\": \"ai-helper\""))
    ...
    #expect((qoderRegistryEntry["relativeLocation"] as? String) == "ai-helper.session-focus-\(version)")
...
private func projectMarketingVersion() -> String {
    let projectURL = URL(fileURLWithPath: #filePath)
        ...
        .deletingLastPathComponent()
        .deletingLastPathComponent()
        .appending(path: "AIHelper.xcodeproj/project.pbxproj")
