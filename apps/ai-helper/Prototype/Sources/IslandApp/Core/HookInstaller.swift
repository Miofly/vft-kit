...
struct HookInstaller {
    ...
    private func resolvedBridgeBinaryPath() -> String {
        let executable = Bundle.main.executableURL?
            ...
            .path()
        return executable ?? "/Users/ai-helper/Island/Prototype/.build/debug/\(Self.bridgeBinaryName)"
    }
    ...
    private func legacyBridgeBinaryPath() -> String {
        let executable = Bundle.main.executableURL?
            ...
            .path()
        return executable ?? "/Users/ai-helper/Island/Prototype/.build/debug/\(Self.legacyBridgeBinaryName)"
    }
    ...
    private func shouldInstallManagedStatusLine(_ existingStatusLine: [String: Any]?) -> Bool {
        ...
        return command == statusLineCommand()
            || command.contains("/.ai-helper/bin/island-statusline")
    }
