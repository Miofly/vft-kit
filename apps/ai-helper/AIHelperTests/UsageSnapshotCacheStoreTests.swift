...
final class UsageSnapshotCacheStoreTests: XCTestCase {
    func testSaveAndLoadClaudeSnapshot() throws {
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("ai-helper-usage-cache-\(UUID().uuidString)", isDirectory: true)
    ...
    func testSaveAndLoadCodexSnapshot() throws {
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("ai-helper-usage-cache-codex-\(UUID().uuidString)", isDirectory: true)
