...
final class OpenCodeIntegrationTests: XCTestCase {
    func testOpenClawManagedProfileUsesHookDirectoryInstallation() {
        ...
        XCTAssertEqual(profile?.primaryConfigurationURL.path, NSHomeDirectory() + "/.openclaw/hooks/ai-helper-openclaw")
        XCTAssertEqual(profile?.activationConfigurationURL?.path, NSHomeDirectory() + "/.openclaw/openclaw.json")
        XCTAssertEqual(profile?.activationEntryName, "ai-helper-openclaw")
    ...
    func testOpenClawConversationParserReadsMultiTurnSessionFile() async throws {
        ...
        let content = """
        {"type":"session","version":3,"id":"openclaw-session","timestamp":"2026-04-11T15:43:20.000Z","cwd":"/Users/ai-helper/.openclaw/workspace"}
    ...
    func testOpenCodeManagedProfileUsesPluginFileInstallation() {
        ...
        XCTAssertEqual(profile?.primaryConfigurationURL.path, NSHomeDirectory() + "/.config/opencode/plugins/ai-helper.js")
    ...
    func testOpenCodeActivationConfigInstallsPluginEntryWithoutRemovingOthers() throws {
        let existingJSON = """
        {
          ...
          "plugin": [
            "file:///Users/ai-helper/.config/opencode/plugins/open-island.js"
          ]
        }
        """.data(using: .utf8)
        ...
        XCTAssertTrue(plugins.contains("file:///Users/ai-helper/.config/opencode/plugins/open-island.js"))
    ...
    func testOpenCodeActivationConfigRemovesOnlyAIHelperPluginEntry() throws {
        let existingJSON = """
        {
          "$schema": "https://opencode.ai/config.json",
          "plugin": [
            "file:///Users/ai-helper/.config/opencode/plugins/open-island.js",
            "file:///Users/ai-helper/.config/opencode/plugins/ai-helper.js"
          ]
        }
        """.data(using: .utf8)
