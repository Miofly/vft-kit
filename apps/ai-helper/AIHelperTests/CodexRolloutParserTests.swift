...
final class CodexRolloutParserTests: XCTestCase {
    func testRolloutParserIgnoresCodexMemoryMaintenanceThread() async throws {
        ...
        let rollout = """
        {"timestamp":"2026-06-27T14:44:29Z","type":"session_meta","payload":{"id":"\(threadId)","cwd":"/tmp/ai-helper-home/.codex/memories","title":"memories","originator":"Codex Desktop","source":"desktop"}}
        ...
        let snapshot = await CodexRolloutParser.shared.parseThread(
            threadId: threadId,
            fallbackCwd: "/tmp/ai-helper-home/.codex/memories",
    ...
    func testRolloutParserPreservesTerminalHostedCodexCLIContext() async throws {
        ...
        let rolloutURL = tempDirectory.appendingPathComponent("rollout-\(threadId).jsonl")
        let rollout = """
        {"timestamp":"2026-04-10T13:51:51Z","type":"session_meta","payload":{"id":"\(threadId)","cwd":"/Users/ai-helper/github/claude-island","originator":"codex-tui","source":"cli"}}
        ...
        let snapshot = await CodexRolloutParser.shared.parseThread(
            threadId: threadId,
            fallbackCwd: "/Users/ai-helper/github/claude-island",
            clientInfo: SessionClientInfo(
                kind: .codexCLI,
                profileID: "codex-cli",
                name: "Codex",
                ...
                processName: "/Users/ai-helper/.nvm/versions/node/v22.21.1/lib/node_modules/@openai/codex/node_modules/@openai/codex-darwin-arm64/vendor/aarch64-apple-darwin/codex/codex"
            )
        )
    ...
    func testRolloutParserInfersPendingMCPApprovalFromUnresolvedToolCall() async throws {
        ...
        let rolloutURL = tempDirectory.appendingPathComponent("rollout-\(threadId).jsonl")
        let rollout = """
        {"timestamp":"2026-04-10T17:41:27.371Z","type":"session_meta","payload":{"id":"\(threadId)","cwd":"/Users/ai-helper/github/CodeIsland","originator":"codex-tui","source":"cli"}}
        ...
        {"timestamp":"2026-04-10T17:41:40.151Z","type":"response_item","payload":{"type":"function_call","name":"mcp__omx_state__state_get_status","arguments":"{\\"workingDirectory\\":\\"/Users/ai-helper/github/CodeIsland\\"}","call_id":"call_IvTKO1mWarOvCiIBwppVMmyt"}}
        """
        try rollout.write(to: rolloutURL, atomically: true, encoding: .utf8)

        let snapshot = await CodexRolloutParser.shared.parseThread(
            threadId: threadId,
            fallbackCwd: "/Users/ai-helper/github/CodeIsland",
            clientInfo: SessionClientInfo(
                kind: .codexCLI,
                profileID: "codex-cli",
                name: "Codex",
    ...
    func testRolloutParserDoesNotInferPendingMCPApprovalForCodexApp() async throws {
        ...
        let rolloutURL = tempDirectory.appendingPathComponent("rollout-\(threadId).jsonl")
        let rollout = """
        {"timestamp":"2026-04-10T17:41:27.371Z","type":"session_meta","payload":{"id":"\(threadId)","cwd":"/Users/ai-helper/github/CodeIsland","originator":"Codex Desktop","source":"desktop"}}
        {"timestamp":"2026-04-10T17:41:27.371Z","type":"event_msg","payload":{"type":"user_message","message":"删除一下 README 文件"}}
        {"timestamp":"2026-04-10T17:41:40.151Z","type":"response_item","payload":{"type":"function_call","name":"mcp__omx_state__state_get_status","arguments":"{\\"workingDirectory\\":\\"/Users/ai-helper/github/CodeIsland\\"}","call_id":"call_IvTKO1mWarOvCiIBwppVMmyt"}}
        """
        try rollout.write(to: rolloutURL, atomically: true, encoding: .utf8)
    ...
    func testRolloutParserSurfacesPendingRequestUserInputCall() async throws {
        ...
        let rolloutURL = tempDirectory.appendingPathComponent("rollout-\(threadId).jsonl")
        let rollout = """
        {"timestamp":"2026-04-24T17:59:20Z","type":"session_meta","payload":{"id":"\(threadId)","cwd":"/Users/ai-helper/Island","originator":"Codex Desktop","source":"desktop"}}
        ...
        let snapshot = await CodexRolloutParser.shared.parseThread(
            threadId: threadId,
            fallbackCwd: "/Users/ai-helper/Island",
            clientInfo: SessionClientInfo(
                kind: .codexApp,
                profileID: "codex-app",
                name: "Codex App",
    ...
    func testRolloutParserExtractsCodexSubagentMetadataFromSessionMeta() async throws {
        ...
        let rolloutURL = tempDirectory.appendingPathComponent("rollout-\(threadId).jsonl")
        let rollout = """
        {"timestamp":"2026-04-18T14:59:02Z","type":"session_meta","payload":{"id":"\(threadId)","forked_from_id":"\(parentThreadId)","cwd":"/Users/ai-helper/Island","originator":"Codex Desktop","source":{"subagent":{"thread_spawn":{"parent_thread_id":"\(parentThreadId)","depth":1,"agent_nickname":"Kierkegaard","agent_role":"explorer"}}},"agent_nickname":"Kierkegaard","agent_role":"explorer"}}
