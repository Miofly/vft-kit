...
final class SessionCompletionStateEvaluatorTests: XCTestCase {
    ...
    func testEndedNotificationAfterWaitingForInputAllowsTrueSessionEnd() {
        ...
        XCTAssertTrue(SessionCompletionStateEvaluator.allowsEndedNotificationAfterWaitingForInput(claude))
    }
    ...
    func testCompletionNotificationPolicyRejectsRecentUntrackedCompletedSessions() {
        let now = Date()
        let session = SessionState(
