...
extension Notification.Name {
    static let aiHelperOpenActiveSessionShortcut = Notification.Name("aiHelperOpenActiveSessionShortcut")
    static let aiHelperOpenSessionListShortcut = Notification.Name("aiHelperOpenSessionListShortcut")
    static let aiHelperPresentNotchDetachmentHint = Notification.Name("aiHelperPresentNotchDetachmentHint")
}
...
final class GlobalShortcutManager {
    ...
    private func handleHotKeyEvent(_ event: EventRef) -> OSStatus {
        ...
        case .openActiveSession:
            NotificationCenter.default.post(name: .aiHelperOpenActiveSessionShortcut, object: nil)
        case .openSessionList:
            NotificationCenter.default.post(name: .aiHelperOpenSessionListShortcut, object: nil)
        }
