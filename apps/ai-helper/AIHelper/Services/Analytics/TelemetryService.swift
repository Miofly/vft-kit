...
struct TelemetryConfiguration: Equatable, Sendable {
    ...
    nonisolated init(
        slsHost: String,
        project: String = "ai-helper",
        logstore: String = "ai-helper",
        topic: String = "product-telemetry",
        source: String = "ai-helper-macos",
    ...
    nonisolated init(infoDictionary: [String: Any] = Bundle.main.infoDictionary ?? [:]) {
        ...
        self.init(
            ...
            project: infoDictionary["PINGTelemetrySLSProject"] as? String ?? "ai-helper",
            logstore: infoDictionary["PINGTelemetrySLSLogstore"] as? String ?? "ai-helper",
            topic: infoDictionary["PINGTelemetrySLSTopic"] as? String ?? "product-telemetry",
            source: infoDictionary["PINGTelemetrySLSSource"] as? String ?? "ai-helper-macos",
...
actor TelemetryService {
    ...
    private static let logger = Logger(subsystem: "com.wfly.aihelper", category: "Telemetry")
