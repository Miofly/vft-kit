...
private let logger = Logger(subsystem: "com.wfly.aihelper", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.wfly.aihelper.agentfilewatcher", qos: .userInitiated)
