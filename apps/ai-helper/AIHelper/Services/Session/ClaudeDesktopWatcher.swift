...
private let logger = Logger(subsystem: "com.wfly.aihelper", category: "ClaudeDesktop")
...
actor ClaudeDesktopWatcher {
    ...
    private func registerSession(metadataURL: URL, localSessionId: String) async -> Bool {
        ...
        // events, so we only pick up content written after ai-helper started watching.
