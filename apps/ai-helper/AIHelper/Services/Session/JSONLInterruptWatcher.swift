...
private let logger = Logger(subsystem: "com.wfly.aihelper", category: "Interrupt")
...
class JSONLInterruptWatcher {
    ...
    private let queue = DispatchQueue(label: "com.wfly.aihelper.interruptwatcher", qos: .userInteractive)
