...
private let logger = Logger(subsystem: "com.wfly.aihelper", category: "Hooks")
...
class HookSocketServer {
    ...
    static let healthCheckRequest = #"{"type":"ai-helper-health-check"}"#
    ...
    private let queue = DispatchQueue(label: "com.wfly.aihelper.socket", qos: .userInitiated)
