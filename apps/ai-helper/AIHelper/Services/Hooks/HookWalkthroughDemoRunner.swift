...
extension Notification.Name {
    static let aiHelperHookWalkthroughDemoShouldCloseNotch = Notification.Name("aiHelperHookWalkthroughDemoShouldCloseNotch")
}
...
final class HookWalkthroughDemoRunner {
    ...
    func start() {
        let sessionId = "ai-helper-demo-\(UUID().uuidString)"
        ...
        Task {
            ...
            await SessionStore.shared.process(.toolCompleted(
                ...
                result: ToolCompletionResult(
                    status: .success,
                    result: AppLocalization.string("ai-helper 已处理这次演示审批。"),
            ...
            await SessionStore.shared.process(.historyLoaded(
                ...
                conversationInfo: ConversationInfo(
                    ...
                    lastToolName: nil,
                    firstUserMessage: AppLocalization.string("体验一轮 ai-helper Hooks 审批通知流程"),
    ...
    private func closeDockedNotchAfterAnswerIfNeeded() {
        ...
        NotificationCenter.default.post(
            name: .aiHelperHookWalkthroughDemoShouldCloseNotch,
            object: nil
        )
    }
    ...
    private static func questionEvent(
        ...
        let toolInput: [String: AnyCodable] = [
            "questions": AnyCodable([
                [
                    "id": "demo_next_step",
                    "header": "1.",
                    "question": AppLocalization.string("是否批准 ai-helper 继续完成这轮演示？"),
                    "description": AppLocalization.string("选择“批准并继续”，再点击提交，ai-helper 会模拟处理完成并弹出通知。"),
                    "options": [
                        [
                            "id": "approve",
        ...
        return HookEvent(
            ...
            message: AppLocalization.string("ai-helper Demo 正在等待一次演示审批。"),
            bridgeIntervention: SessionIntervention(
                id: toolUseId,
                kind: .question,
                title: AppLocalization.string("ai-helper Demo 的审批"),
                ...
                questions: [
                    SessionInterventionQuestion(
                        id: "demo_next_step",
                        header: "1.",
                        prompt: AppLocalization.string("是否批准 ai-helper 继续完成这轮演示？"),
                        detail: AppLocalization.string("选择“批准并继续”，再点击提交，ai-helper 会模拟处理完成并弹出通知。"),
                        options: [
    ...
    private static func demoClientInfo(sessionId: String) -> SessionClientInfo {
        SessionClientInfo(
            kind: .custom,
            profileID: "ai-helper-demo",
            name: "ai-helper Demo",
            launchURL: "aihelper://demo/\(sessionId)",
            origin: "demo"
        )
    }
...
private struct HookWalkthroughDemoBackdropView: View {
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 8) {
                Text(appLocalized: "ai-helper 演示模式")
