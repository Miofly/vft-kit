...
struct IDEExtensionInstaller {
    nonisolated private static let extensionPublisher = "ai-helper"
    ...
    nonisolated private static let projectHomepage = "https://github.com/Miofly/vft-kit"
    nonisolated private static let projectRepository = "https://github.com/Miofly/vft-kit.git"
    nonisolated private static let projectIssues = "https://github.com/Miofly/vft-kit/issues"
    ...
    private static func extensionJS(for profile: ManagedIDEExtensionProfile) -> String {
        ...
        async function handleSetupURI(uri) {
            ...
            await vscode.window.showInformationMessage('ai-helper is ready in \(profile.title).');
        }
