...
struct RemoteEndpoint: Identifiable, Codable, Equatable, Sendable {
    ...
    init(
        ...
        remoteInstallRoot: String = "~/.ai-helper",
        remoteHookSocketPath: String = "~/.ai-helper/run/agent-hook.sock",
        remoteControlSocketPath: String = "~/.ai-helper/run/agent-control.sock",
    ...
    init(from decoder: Decoder) throws {
        ...
        remoteInstallRoot = try container.decodeIfPresent(String.self, forKey: .remoteInstallRoot) ?? "~/.ai-helper"
        remoteHookSocketPath = try container.decodeIfPresent(String.self, forKey: .remoteHookSocketPath) ?? "~/.ai-helper/run/agent-hook.sock"
        remoteControlSocketPath = try container.decodeIfPresent(String.self, forKey: .remoteControlSocketPath) ?? "~/.ai-helper/run/agent-control.sock"
