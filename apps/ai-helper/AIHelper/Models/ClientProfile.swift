...
enum ClientProfileRegistry {
    nonisolated static let managedHookProfiles: [ManagedHookClientProfile] = [
        ManagedHookClientProfile(
            id: "claude-hooks",
            title: "Claude Code",
            subtitle: "管理 ~/.claude/settings.json，使用统一 AIHelperBridge hooks 入口",
        ...
        ManagedHookClientProfile(
            id: "openclaw-hooks",
            title: "OpenClaw",
            subtitle: "管理 ~/.openclaw/hooks/ai-helper-openclaw，并自动启用内部 hook",
            installationKind: .hookDirectory,
            alwaysVisibleInSettings: true,
            logoAssetName: "OpenClawLogo",
            prefersBundledLogoOverAppIcon: true,
            iconSymbolName: "bird.fill",
            configurationRelativePath: ".openclaw/hooks/ai-helper-openclaw",
            activationConfigurationRelativePath: ".openclaw/openclaw.json",
            activationEntryName: "ai-helper-openclaw",
            bridgeSource: "claude",
            bridgeExtraArguments: [
        ...
        ManagedHookClientProfile(
            id: "opencode-hooks",
            title: "OpenCode",
            subtitle: "管理 ~/.config/opencode/plugins/ai-helper.js，按 OpenCode 官方插件 hooks 接入 Island",
            ...
            configurationRelativePath: ".config/opencode/plugins/ai-helper.js",
    ...
    nonisolated static let ideExtensionProfiles: [ManagedIDEExtensionProfile] = [
        ManagedIDEExtensionProfile(
            id: "vscode-extension",
            title: "VS Code",
            subtitle: "安装 ai-helper，支持终端精准聚焦",
        ...
        ManagedIDEExtensionProfile(
            id: "qoder-extension",
            title: "Qoder",
            subtitle: "安装 ai-helper，支持会话跳转与终端精准聚焦",
            logoAssetName: "QoderLogo",
            prefersBundledLogoOverAppIcon: true,
