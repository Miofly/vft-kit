---
name: plugin-refresh
description: "刷新 Claude Code/Codex 插件，将本地源码或 marketplace 更新同步到缓存；用于技能修改未生效、缓存不一致或重新安装。缓存必须是真实副本，禁止软链源码。"
---
...
```bash
bash "${VFT_PLUGIN_ROOT:-${CLAUDE_PLUGIN_ROOT:-${CODEX_PLUGIN_ROOT:-}}}/plugins/vft-kit/skills/agent-ops/plugin-refresh/scripts/refresh-local-plugin.sh" -p <plugin-name>

# marketplace 名与 plugin 名不同时
bash "${VFT_PLUGIN_ROOT:-${CLAUDE_PLUGIN_ROOT:-${CODEX_PLUGIN_ROOT:-}}}/plugins/vft-kit/skills/agent-ops/plugin-refresh/scripts/refresh-local-plugin.sh" -p <plugin> -m <marketplace>
```
...
```bash
bash "${VFT_PLUGIN_ROOT:-${CODEX_PLUGIN_ROOT:-${CLAUDE_PLUGIN_ROOT:-}}}/plugins/vft-kit/skills/agent-ops/plugin-refresh/scripts/refresh-local-codex-plugin.sh" -p <plugin-name>

# marketplace 名与 plugin 名不同时
bash "${VFT_PLUGIN_ROOT:-${CODEX_PLUGIN_ROOT:-${CLAUDE_PLUGIN_ROOT:-}}}/plugins/vft-kit/skills/agent-ops/plugin-refresh/scripts/refresh-local-codex-plugin.sh" -p <plugin> -m <marketplace>
```
