...
1. 运行只读自检：
   ...
   ```bash
   node "${VFT_PLUGIN_ROOT:-${CLAUDE_PLUGIN_ROOT:-${CODEX_PLUGIN_ROOT:-}}}/skills/web-automation/keyboard-maestro/scripts/kmctl.mjs" doctor
   ```
...
```bash
KMCTL="${VFT_PLUGIN_ROOT:-${CLAUDE_PLUGIN_ROOT:-${CODEX_PLUGIN_ROOT:-}}}/skills/web-automation/keyboard-maestro/scripts/kmctl.mjs"
